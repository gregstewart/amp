<?php	
	// Delete additional site info
	$msg = "";
    $action = "deletesite_info";
    $conn = db_connect();
    if ($conn) {
        $sql = "SELECT site_name, url, drop_down, start_pos, left_pos, orientation, menu_spacing FROM site_info WHERE site_id = '$hdn_cat_id'";
